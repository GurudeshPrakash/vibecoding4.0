                    ...
                    return (
                        <div key={item.id || item._id} className="sa-card" style={{ padding: 0, overflow: 'hidden', border: '1px solid #E2E8F0' }}>
                            ...
                            <div style={{ padding: '16px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '8px' }}>
                                    <button onClick={() => setSelectedItem(item)} style={{ flex: 1, padding: '8px', background: 'rgba(6, 182, 212, 0.08)', border: '1px solid rgba(6, 182, 212, 0.25)', borderRadius: '8px', cursor: 'pointer', fontSize: '0.65rem', fontWeight: '700', color: '#06B6D4', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}><Eye size={12} /> Info</button>
